...
export default class header extends Component {
  ...
  searchSong = async () => {
    ...
    if (searchValue) {
      ...
      await data.map((ob) => (songData.push({id: ob.id, title: ob.title, imgUrl: ob.thumbnails.high.url})));
    }
            ...
            <div className="flex">
              <div className="input-group">
                ...
                <div className="input-group-append">
                  <button className="input-group-text red lighten-3" id="basic-text1" onClick={() => this.searchSong()}>
                    Search
                  </button>
                </div>
              </div>
